package com.mapiol.backend.config;

import org.springframework.boot.context.properties.ConfigurationProperties;

/** Liaison typée des propriétés applicatives sous le préfixe {@code mapiol.*} (application.yml). */
@ConfigurationProperties(prefix = "mapiol")
public record MapiolProperties(Jwt jwt, Cors cors, Storage storage, Payment payment) {
